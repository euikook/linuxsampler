...
/* FIXME: disabled for now as it caused an LSCP "RESET" command to unload the
 *        editor DLLs and (probably due to a race) prevented them from reloading
 *        subsequently (see comments in ClosePlugins())
